<template>
    ...
    <nav class="p-5 bg-[#0A0A20] shadow md:flex md:items-center md:justify-between">
      <div class="flex justify-between items-center">
        <router-link to="/" class="my-auto">
          <h1 class="logo mb-0">Willme</h1>
        </router-link>
        <button
          type="button"
          class="relative inline-flex items-center justify-center rounded-md p-2 text-gray-400 hover:bg-gray-700 hover:text-white focus:outline-none focus:ring-2 focus:ring-inset focus:ring-white md:hidden"
      ...
      <ul
        class="md:flex md:items-center md:z-auto md:static absolute bg-[#0A0A20] w-full left-0 md:w-auto md:py-0 py-4 md:pl-0 pl-7 md:opacity-100 transition-all ease-in duration-200"
  ...
  <footer class="border-t-2">
    <div class="container mx-auto p-10 pb-2">
      <div class="flex justify-between flex-col md:flex-row pb-20">
        <router-link to="/" class="my-auto">
          <h2 class="logo mb-0">Willme</h2>
        </router-link>
        <div>
      ...
      <h5 class="text-center text-gray-400 font-bold">© 2023 Willmeow All Rights Reserved.</h5>
    </div>
  </footer>
</template>
